    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBundles", x => new { x.UserId, x.BundleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnlockRate = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BundlesBundleId = table.Column<int>(type: "int", nullable: false),
                    GamesGameId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BundleGame", x => new { x.BundlesBundleId, x.GamesGameId });
                    table.ForeignKey(
                        name: "FK_BundleGame_Bundles_BundlesBundleId",
                        column: x => x.BundlesBundleId,
                        principalTable: "Bundles",
                        principalColumn: "BundleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BundleGame_Games_GamesGameId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasInterface = table.Column<bool>(type: "bit", nullable: false),
                    HasAudio = table.Column<bool>(type: "bit", nullable: false),
                    HasSubtitles = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameLanguages", x => new { x.GameId, x.Language });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayTimeAtReview = table.Column<TimeSpan>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemRequirements", x => x.RequirementId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameOfferedId = table.Column<int>(type: "int", nullable: false),
                    GameRequestedId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tradings", x => x.TradingId);
                    table.ForeignKey(
                        name: "FK_Tradings_Games_GameOfferedId",
                        column: x => x.GameOfferedId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tradings_Games_GameRequestedId",
                        column: x => x.GameRequestedId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tradings_Users_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tradings_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallPath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDLCs", x => new { x.UserId, x.DLCId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BundleGame_GamesGameId",
                table: "BundleGame",
                column: "GamesGameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tradings_GameOfferedId",
                table: "Tradings",
                column: "GameOfferedId");

            migrationBuilder.CreateIndex(
                name: "IX_Tradings_GameRequestedId",
                table: "Tradings",
                column: "GameRequestedId");

            migrationBuilder.CreateIndex(
                name: "IX_Tradings_ReceiverId",
                table: "Tradings",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_Tradings_SenderId",
                table: "Tradings",
                column: "SenderId");
